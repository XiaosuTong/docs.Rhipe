...
my.buildref <- function (docsLoc, outLoc = NULL, pageList = NULL, optTemplates = NULL, 
    ...
    knit = TRUE, purl = TRUE) 
{
    ...
    ll <- c(list(title = windowTitle, extra_css = "", header = pageTitle, 
        side_span = "3", main_span = "9", toc = toc, content = contents, 
        copyright = paste(copyrightText, ", ", format(Sys.time(), 
            "%Y"), sep = ""), first_section = firstSection, extra_header = extraHeader), 
        optTemplates)
...
my.buildref.old <- function (docsLoc, outLoc = NULL, pageList = NULL, navPill = "", 
    editHref = "", copyrightText, windowTitle = NULL, root.dir = NULL, 
    knit = TRUE, purl = TRUE) 
{
    if (is.null(outLoc)) 
...
Tessera</a>"
pill1 <- packageNavPill("https://github.com/tesseradata/RHIPE", docsActive = FALSE)
pill2 <- packageNavPill("https://github.com/tesseradata/RHIPE", docsActive = TRUE)
my.buildref(
   docsLoc       = "docs",
   outLoc        = ".",
   copyrightText = NULL,
   ...
   #navPill       = packageNavPill("https://github.com/tesseradata/RHIPE", docsActive = FALSE),
